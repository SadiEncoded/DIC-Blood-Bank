'use client';
import { SIGNUP_PAGE_CONTENT } from "@/assets/data/signup";
...
export function SignUpHero() {
  ...
  return (
    <Section variant="dark" className="!pt-8 md:!pt-16 !pb-8 md:!pb-16">
      <Container>
      ...
      <div className="relative z-10 text-center">
        ...
        <motion.h1
          ...
          className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight tracking-tight font-anek"
        >
          {title} &nbsp;
        ...
        <motion.p
          ...
          className="text-[13.5px] md:text-md lg:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed md:mb-10 mb-4 font-hind opacity-90"
        >
          {description}
        </motion.p>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {chips.map((chip, i) => (
            ...
            >
              ...
              <span className="text-[8px] md:text-[10px] font-bold text-slate-300 uppercase tracking-widest font-anek">
                {chip.label}
              </span>
            </motion.div>
          ))}
