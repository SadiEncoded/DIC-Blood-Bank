...
import { FOUNDATION_STORY, FOUNDERS, TeamMember } from '@/assets/data/about';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 sm:mb-8 gap-4 sm:gap-6">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-[11px] font-black tracking-[0.4em] text-rose-500 uppercase block mb-3 sm:mb-4">
              Legacy of Phoenix&apos;24
            </span>
            <h2 className="text-xl sm:text-4xl md:text-5xl font-bold text-slate-900 font-anek tracking-tighter">
          ...
          <div className="text-slate-400 text-xs sm:text-sm font-anek italic">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="max-w-4xl mb-12 sm:mb-16 md:mb-20"
        >
          <p className="text-[15px] sm:text-lg md:text-xl text-slate-600 font-hind leading-relaxed">
            ...
            <SwiperSlide key={index}>
              <div className="group flex flex-col md:flex-row gap-8 items-center md:items-start p-2">
                ...
                <div className={`relative pt-4 md:pt-0 border-t md:border-t-0 md:border-l-2 border-primary md:pl-8 transition-colors duration-500 text-center md:text-left`}>
                  ...
                  <p className="text-sm sm:text-lg text-slate-600 font-hind leading-relaxed mb-6 italic">
                    {member.quote}
                  </p>

                  <div>
                    <h4 className="text-lg font-bold text-slate-900 font-anek leading-none">
                      {member.name}
                    </h4>
