...
import { BLOOD_TYPES as bloodTypes } from '@/lib/config';
...
export default function SignUpForm() {
  ...
  return (
    <motion.div
      ...
      className="max-w-4xl mx-auto bg-slate-50 rounded-[2.5rem] border border-slate-200 overflow-hidden shadow-2xl mb-12"
    >
      {/* Header */}
      <div className="bg-rose-900 px-8 py-12 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-rose-500/20 backdrop-blur-md border border-white/10 rounded-full">
          ...
          <div className="space-y-2">
            <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight font-anek uppercase tracking-[0.1em]">
              নিবন্ধন করুন / Sign Up
            </h2>
            <p className="text-rose-100/80 text-sm max-w-md mx-auto">
      ...
      <form onSubmit={onSubmit} noValidate className="p-8 md:p-12 space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2 group">
                <label className="text-[10px] uppercase tracking-widest font-black text-slate-500 ml-1 group-focus-within:text-rose-600 transition-colors">
        ...
        <div className="flex flex-col items-center space-y-6 pt-8 border-t border-slate-200/60">
          <div className="w-full max-w-md">
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-xs text-slate-600 font-hind leading-relaxed">
                আমি স্বেচ্ছায় আমার তথ্য প্রদান করছি এবং <button type="button" className="text-rose-600 font-bold hover:underline">গোপনীয়তা নীতি</button> মেনে নিচ্ছি।
              </span>
            </label>
          ...
          <button 
            ...
            className="w-full md:w-80 px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-rose-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 text-xs tracking-[0.2em] uppercase shadow-xl hover:shadow-rose-100 active:scale-95"
          >
            {isSubmitting ? (
              <>
          ...
          <div className="flex items-center gap-6 text-slate-400 text-[10px]">
            <div className="flex items-center gap-1.5">
              <ShieldCheck size={12} className="text-emerald-500" />
              <span className="uppercase tracking-widest font-bold">SSL Encrypted</span>
            </div>
            <div className="flex items-center gap-1.5">
              <CheckCircle2 size={12} className="text-emerald-500" />
              <span className="uppercase tracking-widest font-bold">GDPR Compliant</span>
            </div>
          </div>
        </div>
      </form>
