...
import { SEARCHPAGE_HERO_CONTENT } from "@/lib/data/search/content";
...
export default function RequestHero() {
  ...
  useEffect(() => {
    getDonorCount().then(c => setCount(c));
  }, []);

  return (
    <Section variant="dark" className="!pt-14 md:!pt-16 !pb-32 md:!pb-40">
      <Container>
      ...
      <div className="relative z-10 text-center">
        ...
        >
          ...
          <span className="text-[10px] md:text-xs font-semibold uppercase tracking-widest text-slate-300">
            {count > 0 ? `${count} Active Heroes` : badge}
          </span>
        </motion.div>
