    ...
    <Section variant="dark" className="!min-h-screen flex items-center !pt-24 !pb-12 md:!pt-32 md:!pb-32 selection:bg-rose-500/30 selection:text-rose-100">
      <Container>
        ...
        >
          ...
          {/* Headline */}
          <h1 className="text-4xl md:text-7xl font-bold tracking-tight text-white leading-[1.1] mb-6 font-poppins">
          ...
          {/* Description */}
          <p className="text-sm md:text-xl text-slate-400 mb-10 max-w-lg leading-relaxed font-light font-hind">
            {HERO_CONTENT.description}
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Link href="/register" className="group relative px-8 py-4 bg-rose-600 hover:bg-rose-700 text-white rounded-2xl font-bold shadow-xl shadow-rose-900/20 transition-all hover:scale-[1.02] active:scale-[0.98] text-center">
              {HERO_CONTENT.cta.donor}
            </Link>
            
            <Link href="/searchDonor" className="group px-8 py-4 bg-white/5 backdrop-blur-md border border-white/10 text-slate-200 rounded-2xl font-bold hover:bg-white/10 transition-all text-center">
